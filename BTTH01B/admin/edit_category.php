...
<body clas="border border-primary">
  ...
  <div class="mt-5 text-center">
    <h2 class="fw-bold">SỬA THÔNG TIN THỂ LOẠI</h2>
    <div class="input-group mt-4 mb-3">
      <span class="input-group-text ms-5" id="inputGroup-sizing-default">Mã thể loại</span>
    ...
    <div class="row">
      ...
      <div class="col-5">
        ...
        <a href="add_category.php" class="btn btn-warning">Quay lại</a>
      </div>
    </div>
</div>
  </div>
